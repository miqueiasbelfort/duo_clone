...
function LessonButton({ id, index, totalCount, locked, current, porcentage }: Props) {
    ...
    return (
        <Link href={href} aria-disabled={locked} style={{ pointerEvents: locked ? "none" : 'auto' }}>
            <div className='relative' style={{ right: `${rigthPosition}px`, marginTop: isFirst && !isCompleted ? 60 : 24 }}>
                {current ? (
