  ...
  return (
    <div className="max-w-[988px] mx-auto flex-1 flex flex-col w-full lg:flex-row items-center justify-center p-4 gap-2">
      ...
      <div className="flex flex-col items-center gap-y-8">
        <h1 className="text-xl lg:text-3xl font-bold text-neutral-600 max-w-[480px] text-center">Learn, practice, and master new language with lingo</h1>
          ...
          <ClerkLoaded>
            ...
            <SignedIn>
              <Button size="lg" variant="secondary" className="w-full" asChild>
                <Link href="learn">Continue Larning</Link>
              </Button>
            </SignedIn>
          </ClerkLoaded>
        </div>
