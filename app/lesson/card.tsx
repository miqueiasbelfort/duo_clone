    ...
    return (
        ...
        >
            ...
            <div className={cn("flex items-center justify-between",
                ...
                <div className={cn("lg:w-[30px] lg:-[30px] w-[20px] h-[20px] border-2 flex items-center justify-center rounded-lg text-neutral-400 lg:text-[15px] text-xs font-semibold",
